...
public class BookmarkFragment
    extends Fragment implements BookmarkAdapter.BookmarkAdapterCallback {
  ...
  public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    RecyclerView bookmarksView =
        (RecyclerView)mRootView.findViewById(R.id.rv_bookmarks);
    ...
    bookmarksView.addItemDecoration(new DividerItemDecoration(
        getActivity(), DividerItemDecoration.VERTICAL));

    adapter = new BookmarkAdapter(
        getActivity(), BookmarkTable.getBookmarksForID(mBookId, getActivity()),
        this, config);
